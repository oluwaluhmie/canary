...
const StoryHeader = () => {
  return (
    <div className="flex flex-col items-center bg-story-sm md:bg-story-md lg:bg-story-lg bg-cover">
      <div className="flex flex-col w-107.5 md:w-200 lg:w-341.5">
        <div className="flex flex-col px-5 md:px-12 lg:px-12 py-5 md:py-12 lg:py-12 h-full">

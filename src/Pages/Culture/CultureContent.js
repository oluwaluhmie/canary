    ...
    <div className="flex flex-col items-center bg-white md:bg-culturebg md:bg-cover">
      <div className="flex flex-col items-center w-107.5 md:w-200 lg:w-341.5">
        ...
        <div className="flex flex-col lg:items-center bg-menuTextHover md:bg-culturepoliciesbg w-full">
          <div className="flex flex-col items-center px-5 md:px-12 lg:px-0 py-12 md:py-16 lg:py-24 w-107.5 md:w-200 lg:w-341.5 overflow-hidden lg:items-center">
            <div className="flex flex-col gap-6 md:gap-12 lg:gap-16 w-97.5 md:w-176 lg:w-300">

  ...
  return (
    <div className="flex flex-col items-center bg-white md:bg-culturebg md:bg-cover">
      <div className="flex flex-col w-full">
        <div className="flex flex-col px-12 lg:px-32 pt-12 pb-16 gap-12 md:py-16 md:gap-16">
          <div className="flex flex-col md:flex-row gap-8 lg:gap-16">
            <div className="flex flex-col gap-1 md:gap-3 md:w-84 lg:w-148.5">
          ...
          <div className="flex flex-col gap-5 pt-6 md:gap-6 md:py-6 lg:gap-12 lg:py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-y-12">
              <div className="border-b-2 border-blueBorderStroke shadow-culture md:h-78 md:w-86 lg:w-96 lg:h-84 bg-white">
                ...
                <p className="text-mobileMenuColor text-base lg:text-lg px-4 lg:px-6 pt-4 lg:pt-6 pb-6 lg:pb-8 border-x-2 border-borderStroke md:h-34 lg:h-36">
                  We take responsibility for our actions and are accountable to
                  our clients, shareholders, and employees.
                </p>
              </div>
              <div className="border-b-2 border-growthBorder shadow-culture md:h-78 md:w-86 lg:w-96 lg:h-84 bg-white">
                <div className="flex items-end relative">
                  <p className="font-gotham text-white text-xl px-4 py-4 absolute">
                    Growth
                  </p>
              ...
              <div className="border-b-2 border-menuHover shadow-culture md:h-78 md:w-86 lg:w-96 lg:h-84 bg-white">
                <div className="flex items-end relative">
                  <p className="font-gotham text-white text-xl px-4 py-4 absolute">
                    Innovation
                  </p>
              ...
              <div className="border-b-2 border-loyalBorder shadow-culture md:h-78 md:w-86 lg:w-96 lg:h-91 bg-white">
                <div className="flex items-end relative">
                  <p className="font-gotham text-white text-xl px-4 py-4 absolute">
                    Loyalty
                  </p>
                ...
                <p className="text-mobileMenuColor text-base lg:text-lg px-4 lg:px-6 pt-4 lg:pt-6 pb-6 lg:pb-8 border-x-2 border-borderStroke md:h-34 lg:h-43">
                  We are loyal to our clients and we are committed to building
                  long-term relationships based on trust and mutual respect.
                </p>
              </div>
              <div className="border-b-2 border-excelBorder shadow-culture md:h-78 md:w-86 lg:w-96 lg:h-91 bg-white">
                <div className="flex items-end relative">
                  <p className="font-gotham text-white text-xl px-4 py-4 absolute">
                    Excellence
                  </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12 md:gap-6 lg:gap-24 py-6 lg:py-16 lg:w-300">
            <div className="flex flex-col gap-6 lg:gap-12 lg:w-110">
              <span className="font-gotham text-2xl md:text-3xl text-transparent bg-clip-text bg-gradient-to-b from-blueTextGradient-start to-blueTextGradient-end">
                Desired Behaviours
              </span>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-5 md:gap-6 lg:gap-5 lg:w-110">
                <div>
                  <span className="text-menuHover text-base lg:text-xl">Proactive:</span>
                  <p className="text-mobileMenuColor text-base md:w-84 lg:w-110">
        ...
        <div className="px-10 md:px-16 lg:px-36 bg-menuTextHover md:bg-culturepoliciesbg w-full">
          <div className="py-12 md:py-16">
            <div className="flex flex-col gap-6 md:gap-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-5 lg:gap-x-6">
                <div className="flex flex-col gap-3 px-4 py-5 bg-white shadow-culture lg:w-96">
                  <img
                    src={performance}
                    alt="performance"
                    className="w-8 h-8 md:w-9 md:h-9 lg:w-12 lg:h-12"
                  />
                  <div className="flex flex-col gap-1 lg:w-86">

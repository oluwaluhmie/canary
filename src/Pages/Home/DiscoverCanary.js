        ...
        <div className="flex flex-col gap-6 md:gap-10 w-97.5 md:w-176 lg:w-138">
          <div className="flex flex-col gap-1 md:gap-2 lg:gap-3 lg:py-6">
            ...
            <p className="text-mobileMenuColor text-base lg:text-xl">
              ...
              House in Nigeria. Backed by seasoned professionals with extensive
              industry experience, and with a deep understanding of local
              markets and client expectations, we bridge financing gaps and
              deliver top-tier services.
            </p>
          </div>
          <Link
            to="/ourstory"

...
const Investor = () => {
  return (
    <div className="flex flex-col items-center bg-investorbg bg-cover overflow-hidden">
      <div className="flex flex-col items-center w-107.5 md:w-200 lg:w-341.5">
        <div className="flex flex-col w-97.5 md:w-200 lg:w-300">
          <div className="flex flex-col items-center py-16 md:py-12 lg:py-24 gap-12 md:gap-12 lg:gap-16">
            <div className="flex flex-col gap-12 md:gap-12 lg:gap-12 w-97.5 md:w-176 lg:w-300">
              <div className="flex flex-col gap-2 lg:gap-3">
                ...
                <p className="text-base md:text-base lg:text-lg text-mobileMenuColor w-97.5 md:w-176 lg:w-160">
                  ...
                  designed to build long-term wealth and security. Our
                  investment plans provide stability and growth potential to
                  ...
                  <div className="flex flex-col md:flex-row lg:flex-col md:justify-between lg:items-end gap-5 lg:gap-16">
                    <div className="w-87.5 md:w-128 lg:w-84 lg:flex lg:flex-col lg:gap-1">
                      ...
                      <p className="text-base text-mobileMenuColor">
                        ...
                        savings culture through periodic contributions towards
                        set goals.
                      </p>
                    </div>
                    <div className="flex items-end">
                      ...
                      >
                        <p className="text-base text-menuHover">Apply Now</p>
                ...
                <div className="flex flex-col gap-4 lg:gap-16 px-5 lg:px-6 py-6 lg:py-8 bg-white w-97.5 md:w-176 lg:w-96 lg:h-96">
                  ...
                  <div className="flex flex-col md:flex-row lg:flex-col md:justify-between lg:items-end gap-5 lg:gap-16">
                    <div className="w-87.5 md:w-128 lg:w-84 lg:flex lg:flex-col lg:gap-1">
                      ...
                      <p className="text-base text-mobileMenuColor">
                        Tailored to instil financial discipline among investors
                        by locking away their investment, only accessible after

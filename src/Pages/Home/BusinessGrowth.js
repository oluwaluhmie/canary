...
const BusinessGrowth = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-businessbg bg-cover overflow-hidden">
      <div className="flex flex-col items-center py-16 md:py-12 lg:py-32 gap-12 md:gap-12 lg:gap-16 w-97.5 md:w-176 lg:w-300">
          ...
          <div className="hidden md:hidden lg:grid lg:grid-cols-3 gap-3">
            <div className="col-span-2">
              <div className="lg:flex lg:flex-col lg:py-3 lg:gap-3 lg:w-199">
                ...
                <p className="text-base lg:text-lg text-mobileMenuColor lg:w-160">
                  With our range of loan products, businesses can access medium
                  to long-term financing solutions tailored to their needs. Our
                  structured financing options provide the flexibility and
                  support to propel your business forward.
                </p>
              </div>
            </div>
            <div

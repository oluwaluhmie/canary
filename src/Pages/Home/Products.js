    ...
    <div className="flex flex-col items-center bg-productsbg bg-cover relative">
      <div className="flex flex-col w-97.5 md:w-176 lg:w-300 py-16 md:py-16 lg:py-32 gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="grid grid-cols-1 gap-5 md:gap-5 lg:gap-6 md:grid-cols-1 lg:grid-cols-3">
          <div className="flex flex-col md:flex-row lg:flex-col md:w-176 lg:w-96 bg-menuTextHover drop-shadow-md shadow-menuHover border-b-4 border-productsBorder hover:bg-gradient-to-b hover:from-productsHover-start hover:to-productsHover-end transition-all duration-3000 ease-out">

  ...
  <div className="flex flex-col gap-12">
    ...
    <div className="flex flex-col gap-6 lg:gap-12 gap-x-3 md:gap-x-4 lg:gap-x-6 w-97.5 md:w-176 lg:w-300">
      <div className="grid grid-cols-2">
        <div className="flex flex-col bg-teamsBg hover:bg-menuTextHover border-b-2 border-productsBorder md:border-productsBorder/0 hover:border-b-2 hover:border-productsBorder hover:shadow-products transition-opacity duration-1000 w-43.5 md:w-85 lg:w-147">

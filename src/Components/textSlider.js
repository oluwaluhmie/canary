...
const TextSlider = () => {
  const text1 = (
    <>
      <div className="flex flex-col gap-2 md:gap-2 lg:gap-3 w-100 md:w-128 lg:w-150 h-64 md:h-60 lg:h-70.5">
        ...
        <p className="text-searchBoxText text-lg md:text-lg lg:text-xl w-100 md:w-128 lg:w-128">
